            ...
            <div className="flex flex-1 items-center justify-end md:justify-between">
              <nav aria-label="Global" className="hidden md:block">
                <ul className="flex items-center gap-6 text-sm">
                  <li>
                    <Link className="text-white transition hover:text-white/75" href="/about-us"> About </Link>
                  </li>
        
                  <li>
                    <a className="text-white transition hover:text-white/75" href="/categories"> Categories </a>
                  </li>
        
                  <li>
                    <Link className="text-white transition hover:text-white/75" href="/product"> All Products </Link>
                  </li>
        
                  <li>
                    <a className="text-white transition hover:text-white/75" href="/blogs"> Blog </a>
                  </li>
                </ul>
              </nav>
              ...
              <div className="flex items-center gap-4">
                <div className="sm:flex sm:gap-4">
                  <Link className="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700" href="#">
                    Login
                  </Link>
